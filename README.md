...
```
* * * * * /usr/bin/clickTT -i                                    > all.ics
* * * * * /usr/bin/clickTT -i -a                                 > all-with-alarms.ics
* * * * * /usr/bin/clickTT -i -L "J19 BK" -g "TTG Bischweier"    > herren-1.ics
* * * * * /usr/bin/clickTT -i -a -L "J19 BK" -g "TTG Bischweier" > herren-1-with-alarms.ics
* * * * * /usr/bin/clickTT -i -l "J19 BK"                        > j19.ics
* * * * * /usr/bin/clickTT -i -a -l "J19 BK"                     > j19-with-alarms.ics
* * * * * /usr/bin/clickTT -i -g "TTG Bischweier II"             > herren-2.ics
* * * * * /usr/bin/clickTT -i -a -g "TTG Bischweier II"          > herren-2-with-alarms.ics
* * * * * /usr/bin/clickTT -i -g "TTG Bischweier III"            > herren-3.ics
* * * * * /usr/bin/clickTT -i -a -g "TTG Bischweier III"         > herren-3-with-alarms.ics
```
